...
public class GenderClassifier implements ClassifierGender {
     ...
     * @throws IOException
     */
    public static ClassifierGender create(AssetManager assetManager, String modelFilename, String labelFilename, int inputSize, int imageMean, float imageStd, String inputName, String outputName) {
        GenderClassifier c = new GenderClassifier();
